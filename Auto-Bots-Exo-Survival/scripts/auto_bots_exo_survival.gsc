...
#define ABES_DEFAULT_REACTION_TIME                0.05
#define ABES_MIN_REACTION_TIME                    0.01
#define ABES_MAX_REACTION_TIME                    0.25
...
buildModState()
{
    ...
    state.botCount = 0;
    state.botSkill = 1.0;
    state.reactionTime = ABES_DEFAULT_REACTION_TIME;
...
initDvars()
{
    ...
    setdvarifuninitialized( "scr_es_autobots_reaction_time", ABES_DEFAULT_REACTION_TIME );
...
refreshRuntimeConfig()
{
    ...
    // Smaller reaction times make bots respond faster; extremely tiny values can increase server CPU usage.
    level.abes.reactionTime = abesClamp( getdvarfloat( "scr_es_autobots_reaction_time" ), ABES_MIN_REACTION_TIME, ABES_MAX_REACTION_TIME );
