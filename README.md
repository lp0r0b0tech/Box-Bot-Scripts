...
Inside `s1`, create a `scripts` folder. For the files currently present in this repository root, create `mp` and `zm` inside `s1/scripts`; no `sv` folder is needed for these listed files.
