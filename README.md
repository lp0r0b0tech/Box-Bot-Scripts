...
All upgraded weapons use a Cell 3 Cauterizer-style damage curve

Inside `s1`, create a `scripts` folder. For the files listed below, create `mp` and `zm` inside `s1/scripts`.
